# -*- coding: utf-8 -*-
"""
Created on Thu May 23 08:11:29 2019
...
class MusicSpider:
    ...
    def get_content_list(self):
        ...
        for tr in tr_list:
            item = {}
            #item["download_url"] = tr.get_attribute("id")[:-13]
            
            item["download_url"]="http://music.163.com/song/media/outer/url?id={}.mp3".format(tr.get_attribute("id")[:-13])
            #print (item)
